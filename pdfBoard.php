...
$html .= resultHeaderPDF($conn, $dept, $field, $degree, $sec);

$html .= processBoardResultPDF($conn,$field,$effectivedate,$external,$dept,$resulttype);
...
$mpdf->Output("BroadSheet.pdf", "D"); // force download
