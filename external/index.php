...
if (isset($_POST['submit'])) {
  ...
  if (!file_exists($_FILES["signature"]["tmp_name"])) {
    ...
    addExternalNoSign($conn, $title, $lname, $fname, $initial, $dept, $filename, $admin);
  }
  // Validate file input to check if is with valid extension
    ...
    addExternal($conn, $title, $lname, $fname, $initial, $dept, $filename, $tempname, $folder, $admin);
  }
}
...
if (isset($_POST['edit'])) {
  ...
  if (!file_exists($_FILES["signature"]["tmp_name"])) {
    ...
    updateExternalNoSign($conn, $title, $lname, $fname, $initial, $user, $admin);
  }
  // Validate file input to check if is with valid extension
  else if (!in_array($file_extension, $allowed_image_extension)) {
    echo "<script>alert('Error: Please Upload valid Signature. Only PNG and JPEG are allowed.')</script>";
    ...
    updateExternal($conn, $title, $lname, $fname, $initial, $user, $filename, $tempname, $folder, $admin);
  }
}
...
if (isset($_GET['status'])) {
  ...
  $status = $_GET['status'];
  statusExternal($conn, $user_id, $status, $admin);
}
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create External</h1>
            ...
            <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#addHod">
              <i class="fas fa-plus fa-sm text-white-50"></i> Add External Examiner
            </button>
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Add New External Examiner</h5>
          ...
          <div class="contain">
            <table class="table cmt" id="myTable">
              ...
              <?php
              $queryDisplay = displayExternal($conn, $dept);
              $i = 0;
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="modal fade" id="editHod" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Edit External Examiner</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                  ...
                  <td>
                    ...
                    if ($status == 0) {
                      ...
                      echo "<a href='../function/script.php?user_id=$user_id&admin=$admin&status=$status&external=external&admin=$admin' class='danger'>Disable</a>";
                    } elseif ($status == 1) {
                      echo "<a href='../function/script.php?user_id=$user_id&admin=$admin&status=$status&external=external&admin=$admin' class='success'>Enable</a>";
                    }
