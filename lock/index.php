...
if (isset($_GET['department'])) {
    ...
    $board = $_GET["board"];
    $update = "UPDATE testscore SET status = 1,board_date = '$board' WHERE dept = '$department' AND degree = '$degree' AND field = '$field' AND effectivedate = '$effectivedate'";
    $resultp = mysqli_query($conn, $update);

    if ($resultp) {
        echo "<script>alert('Result Successfully Locked')</script>";
        echo "<script>location.replace('../dashboard.php?p=exam&user=$user')</script>";
    } else {
...
-->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Lock Board Approved Result</h1>
                    ...
                    <div id="form" class="contain">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if ($result = mysqli_query($conn, $query)) {
                                ...
                                echo "<a href='index.php?department=$department&degree=$degree&field=$field&effectivedate=$effectivedate&board=$board' class='lock'>Lock Up Result</a>";
