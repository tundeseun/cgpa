...
if(isset($_POST['field']) && isset($_POST['effective_date'])){
    ...
    $query = "SELECT DISTINCT testscore.external,external_cgpa.fname,external_cgpa.lname FROM testscore inner join external_cgpa on external_cgpa.id=testscore.external WHERE field = $fieldID";
