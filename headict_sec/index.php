...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item ">
        <a class="nav-link" href="../dashboard.php?p=head&user=<?php echo $user ?>">
      ...
      .oninput = e => console.log(new Date(e.target.valueAsNumber, 0, 1))
                  ...
                  <form action="" method="post" class="forms" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label for="date">Enter Section:</label>
                        <div class="sec">
                        <input type="number" name="four" placeholder="YYYY" min="1999" max="2090">
                        <div class="btwnum"><?php echo "/"?></div>
                        <input type="number" name="two" placeholder="YY" min="10" max="90">
          ...
          <div class="contain">
            <table class="table cmt" id="myTable">
              ...
              <?php
              $queryDisplay = displaySection($conn);
              $i = 0;
