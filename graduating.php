...
$html .= GradListHeaderPDF($conn, $dept, $field, $degree, $sec, $resulttype);

$html .= processGradutingList($conn, $field, $effectivedate, $dept, $degree, $resulttype);
...
$mpdf->Output("GraduatingList.pdf", "D"); // force download
