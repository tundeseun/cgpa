...
if (isset($_POST['submit'])) {
  ...
  if (!file_exists($_FILES["signature"]["tmp_name"])) {
    ...
    $filename = '';
    addHod($conn, $title, $lname, $fname, $initial, $designation, $dept, $admin);
  }
  // Validate file input to check if is with valid extension
    ...
    addHodWithSignature($conn, $title, $lname, $fname, $initial, $designation, $dept,$filename, $tempname, $folder, $admin);
  }
}
...
if (isset($_POST['edit'])) {
  ...
  if (!file_exists($_FILES["signature"]["tmp_name"])) {
    ...
    updateHod($conn, $title, $lname, $fname, $initial, $designation, $user, $admin);
  }
  // Validate file input to check if is with valid extension
  else if (!in_array($file_extension, $allowed_image_extension)) {
    echo "<script>alert('Error: Please Upload valid Signature. Only PNG and JPEG are allowed.')</script>";
    ...
    updateHodWithSignature($conn, $title, $lname, $fname, $initial, $user, $filename, $tempname, $folder, $admin, $designation);
  }
}
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Hod</h1>
            ...
            <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#addHod">
              <i class="fas fa-plus fa-sm text-white-50"></i> Add HOD
            </button>
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Add New Hod</h5>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <select name="designation" id="designation">
                          <option value=""></option><?php
                                                    $queryDesig = getDesig($conn);
                                                    while ($rowDesig = mysqli_fetch_assoc($queryDesig)) {


                                                    ?>
                            <option value="<?php echo $rowDesig['id']; ?>">
                              <?php echo $rowDesig['title']; ?>
                            </option>
                          <?php } ?>
                        </select>
                      </div>
          ...
          <div class="contain">
            <table class="table cmt" id="myTable">
              ...
              <?php
              $queryDisplay = displayHod($conn, $dept);
              $i = 0;
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <?php echo $rowDisplay['designation']; ?>
                  </td>
                  <td>
                    <!-- Button trigger modal -->
                        ...
                        <div class="modal-content">
                          ...
                          <form action="" method="post" class="forms" enctype="multipart/form-data">
                            <div class="modal-body">
                              ...
                              <div class="form-group">
                                <label for="designation"> Select Designation:&nbsp;<span class="note">(please confirm designation)</span></label>
                                <select name="Edesignation" id="designation">

                                  <?php
                                  $queryDesigEdit = getDesig($conn);
                                  while ($rowDesigEdit = mysqli_fetch_assoc($queryDesigEdit)) {


                                  ?>
                                    <option value="<?php echo $rowDesigEdit['id']; ?>">
                                      <?php echo $rowDesigEdit['title']; ?>
                                    </option>
                                  <?php } ?>
                                </select>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="file" name="signature" id="sign">
                  ...
                  <td>
                    ...
                    if ($status == 0) {
                      ...
                      echo "<a href='../function/script.php?user_id=$user_id&status=$status&hod=hod&admin=$admin&dept=$dept' class='danger'>Disable</a>";
                    } elseif ($status == 1) {
                      echo "<a href='../function/script.php?user_id=$user_id&status=$status&hod=hod&admin=$admin&dept=$dept' class='success'>Enable</a>";
                    }
