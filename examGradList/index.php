...
-->
        ...
        <div class="container-fluid">
          ...
          <div id="form" class="contain">
            ...
            <form action="../graduatingWord.php" method="get">
            <h4> Download Graduating List </h4>
              <div class="form-group mb">
                <label for="dept">Select Department:</label>

                <select name="dept" id="dept" onchange="showUser(this.value)" required>
                  <?php
  ...
  <script type="text/javascript" src="../selectExamGradListField.js"></script>
