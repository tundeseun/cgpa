...
$query = "SELECT DISTINCT board_date FROM testscore";
        ...
        <div class="container-fluid">
          ...
          <div id="form" class="contain">
            ...
            <form action="../order.php" method="get">
              <h4> Download Order Of Proceedings </h4>
              <div class="form-group mb">
                <label for="dept">Select Board Date:</label>
                <select name="board" id="board">
                  ...
                  ?>
                    <option value="<?php echo $row['board_date'] ?>"> <?php echo  $row['board_date'] ?> </option>
                  <?php } ?>
